...
| --------------- | --------------- | --------- | ------------ |
| Angular 17      | >= v17.0.0      | `latest`  | ✅ Supported |
...
Each release branch (`release/vN`) maps to one Angular major version. npm **dist-tags** (`latest`, `ng17`, `ng16`, …) let users install the right version for their Angular version without knowing exact patch numbers.
...
| `ng17`   | latest patch for v17  | Angular 17 users pinned to that tag |
| `ng17`   | latest patch for v17  | Angular 17 users pinned to that tag |
| …        | …                     | …                                   |
