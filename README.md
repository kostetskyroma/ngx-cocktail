...
| --------------- | --------------- | --------- | ------------ |
| Angular 18      | >= v18.0.0      | `latest`  | ✅ Supported |
...
Each release branch (`release/vN`) maps to one Angular major version. npm **dist-tags** (`latest`, `ng18`, `ng17`, …) let users install the right version for their Angular version without knowing exact patch numbers.
